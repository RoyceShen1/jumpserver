...
urlpatterns = patterns('juser.views',
                       ...
                       # deal requests from users
                       url(r'^request/deal/$', 'request_deal', name='request_deal'),
                       url(r'^request/put/$', 'request_put', name='request_put'),
                       url(r'^request/process/$', 'request_process', name='request_process'),
                       )
