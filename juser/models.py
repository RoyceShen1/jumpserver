...
class User(AbstractUser):
    ...
    week_times = models.IntegerField(blank=True, null=True, verbose_name=u'周登录次数')
    month_times = models.IntegerField(blank=True, null=True, verbose_name=u'月登录次数')
    quarter_times = models.IntegerField(blank=True, null=True, verbose_name=u'季度登录次数')
    year_times = models.IntegerField(blank=True, null=True, verbose_name=u'年登录次数')
