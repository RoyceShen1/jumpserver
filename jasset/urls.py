...
urlpatterns = patterns('',
    ...
    url(r'^asset/update_excel/$', asset_update_from_excel, name='asset_update_from_excel'),
    url(r'^asset/update_batch/$', asset_update_batch, name='asset_update_batch'),
    url(r'^asset/upload/$', asset_upload, name='asset_upload'),
    url(r'^asset/upload/to/update/$', asset_upload_to_update, name='asset_upload_to_update'),
